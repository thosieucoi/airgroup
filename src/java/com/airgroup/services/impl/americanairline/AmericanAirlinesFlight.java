...
public class AmericanAirlinesFlight extends SearchFlights {
	...
	protected Response getResponse(CuriositySearch search) throws InterruptedException,
		...
		AmericanAirlinesRequestFirst requestFirst = new AmericanAirlinesRequestFirst();
		...
		AmericanAirlinesLanguage language = new AmericanAirlinesLanguage();
		Response languageResponse = language.getResponse(search);

		AmericanAirlinesRequest request = new AmericanAirlinesRequest();
		Response cookieResponse = request.getResponseWithCookies(
			search,
			languageResponse.getCookies());

		AmericanAirlinesProcess process = new AmericanAirlinesProcess();
		process.getResponseWithCookies(search, languageResponse.getCookies());

		AmericanAirlinesRequestResult requestResult = new AmericanAirlinesRequestResult();
		requestResult.getResponseWithCookies(search, languageResponse.getCookies());

		AmericanAirlinesResult result = new AmericanAirlinesResult();
