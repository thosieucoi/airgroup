 ...
 * 
 */
public class MalaysiaAirlinesFareSearch extends FlightResponse {

	private static final String URL = "https://bookings.malaysiaairlines.com/MHOnline/AirLowFareSearch.do";
	...
	public FluentStringsMap getParams() {
		...
		params.add(
			...
			String.valueOf(search.getOutboundDate().getMonthOfYear()));
		params.add(
			"outboundOption.departureDay",
			String.valueOf(search.getOutboundDate().getDayOfMonth()));
		params.add(
		...
		if(search.isRoundtrip()){
			...
			params.add(
				...
				String.valueOf(search.getInboundDate().getMonthOfYear()));
			params.add(
				"inboundOption.departureDay",
				String.valueOf(search.getInboundDate().getDayOfMonth()));
			params
		...
		params.add("guestTypes[2].amount", search.getInfantsCountString());
