 ...
 * 
 */
public class PhilippineAirlinesFareSearch extends FlightResponse {

	private static final String URL = "https://onlinebooking.philippineairlines.com/flypal/AirLowFareSearch.do";
	...
	public FluentStringsMap getParams() {
		...
		if(search.isRoundtrip()){
			...
			params.add("inboundOption.departureDay", DAY_FORMATTER.print(search.getInboundDate()));
			params
		...
		params.add("multiCityOptions[0].originLocationCode", search.getDepartureCode());
		params.add("multiCityOptions[0].originLocationType", "");
		params.add("multiCityOptions[0].destinationLocationCode", search.getArrivalCode());
		params.add("multiCityOptions[0].destinationLocationType", "A");
		params.add(
		...
		if(search.isRoundtrip()){
			...
			params.add("multiCityOptions[1].originLocationCode", search.getArrivalCode());
			params.add("multiCityOptions[1].originLocationType", "");
			params.add("multiCityOptions[1].destinationLocationCode", search.getDepartureCode());
			params.add("multiCityOptions[1].destinationLocationType", "A");
			params.add(
