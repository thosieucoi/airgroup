...
public class DeltaAirlinesProcess extends FlightResponse {
	...
	public String getURL() {
		return "https://abacuswebstart.abacus.com.sg/vietnam-booking/flight-search-process.aspx";
	}
	...
	public FluentStringsMap getParams() {
		...
		params.add("class", search.getParamValue("cabin").toString());
		...
		params.add("labour", "0");
		params.add("prefAirline", ",Delta Air Lines Inc (DL)");
		params.add("seaman", "0");
