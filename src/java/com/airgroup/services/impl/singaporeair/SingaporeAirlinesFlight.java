...
public class SingaporeAirlinesFlight extends SearchFlights {
	...
	protected Response getResponse(CuriositySearch search) throws InterruptedException,
		...
		SingaporeAirlinesRequestFirst requestFirst = new SingaporeAirlinesRequestFirst();
		...
		SingaporeAirlinesLanguage language = new SingaporeAirlinesLanguage();
		Response languageResponse = language.getResponse(search);

		SingaporeAirlinesRequest request = new SingaporeAirlinesRequest();
		Response cookieResponse = request.getResponseWithCookies(
			search,
			languageResponse.getCookies());

		SingaporeAirlinesProcess process = new SingaporeAirlinesProcess();
		process.getResponseWithCookies(search, languageResponse.getCookies());

		SingaporeAirlinesRequestResult requestResult = new SingaporeAirlinesRequestResult();
		requestResult.getResponseWithCookies(search, languageResponse.getCookies());

		SingaporeAirlinesResult result = new SingaporeAirlinesResult();
