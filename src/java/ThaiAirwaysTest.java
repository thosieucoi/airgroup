...
public class ThaiAirwaysTest {
	...
	public static void main(String args[]) throws InterruptedException, ExecutionException,
		...
		ThaiAirwaysFlight flight = new ThaiAirwaysFlight();
		CuriositySearch search = new CuriositySearch();
		search.setDepartureCode("HAN");
		search.setArrivalCode("BKK");
		search.setOutboundDate(DATE_TIME_FORMATTER.parseDateTime("20130923"));
		search.setInboundDate(DATE_TIME_FORMATTER.parseDateTime("20130928"));
