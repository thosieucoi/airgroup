 ...
 */
class TourIntro extends WcmContent {
    ...
    String introductionGeneral
	String introductionAsia
	String introductionAmerica
	String introductionEurope
	String introductionDomestic
	String introductionSouthEastAsia
	String title = "Tour Intro"
	Integer validFor = 0
	String aliasURI = "intro"
     ...
     */
    static constraints = {
        introductionGeneral(nullable: false, maxSize: WcmContent.MAX_CONTENT_SIZE)
		introductionAsia(nullable: false, maxSize: WcmContent.MAX_CONTENT_SIZE)
		introductionAmerica(nullable: false, maxSize: WcmContent.MAX_CONTENT_SIZE)
		introductionEurope(nullable: false, maxSize: WcmContent.MAX_CONTENT_SIZE)
		introductionDomestic(nullable: false, maxSize: WcmContent.MAX_CONTENT_SIZE)
		introductionSouthEastAsia(nullable: false, maxSize: WcmContent.MAX_CONTENT_SIZE)
    }
     ...
     */
    static editors = {
        introductionGeneral(editor:'HTMLContent')
		introductionAsia(editor:'HTMLContent')
		introductionAmerica(editor:'HTMLContent')
		introductionEurope(editor:'HTMLContent')
		introductionDomestic(editor:'HTMLContent')
		introductionSouthEastAsia(editor:'HTMLContent')
		title(hidden:true)
    }
