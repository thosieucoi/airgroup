			...
			*/
			...
			interceptUrlMap = [
			  ...
			  '/moneycode/edit/*':         ['ROLE_ACCOUNTING','ROLE_ADMIN','IS_AUTHENTICATED_FULLY'],
			   ...
			   '/order/**':             	 ['ROLE_ADMIN','ROLE_ACCOUNTING','ROLE_USER'],
			   '/CMSFeedback/**':       	 ['ROLE_ADMIN','ROLE_ACCOUNTING','ROLE_USER'],
			   '/rate/index':        		 ['ROLE_ADMIN','ROLE_ACCOUNTING','ROLE_USER'],
		       '/rate/list':        	     ['ROLE_ADMIN','ROLE_ACCOUNTING','ROLE_USER'],
		       '/rate/save':        	     ['ROLE_ADMIN','ROLE_ACCOUNTING','ROLE_USER'],
