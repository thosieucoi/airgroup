	...
	<body>
		<div id="tour-section" class="row">
			...
			<section class="row">
				...
				<article class="col-md-3 col-sm-3 col-xs-3" style="padding: 0">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<label id="diem-di-label" for="diem-di-input"
									...
									value="${contentDetails.fromCode}" width="170px" />
							</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<label id="diem-den-label" for="diem-den-input"
									...
									value="${contentDetails.toCode}" width="170px" />
							</div>
						</div>
