					...
					<div class="debook">
						...
						<div class="debook">
							...
							<p>Khách hàng có thể chọn các phương thức thanh toán khác
								...
								cổng thanh toán , hoặc thanh toán tại văn phòng của HPV</p>

						</div>
						<div class="debook">
						<strong>Bước 5: Nhận thông báo Hoàn tất đơn hàng từ HPV và Email
								thông báo gửi cho khách hàng.</strong>
							<p>Sau khi khách hàng hoàn tất đơn hàng , nhân viên HPV sẽ
								liên lạc lại với quý khách hàng để hỗ trợ khách hàng trong thời
								gian sớm nhất.</p>
							<p>
								<b>Trong quá trình đặt vé nếu có gì thắc mắc hoặc gặp khó
									khăn , hãy liên hệ với nhân viên của HPV . Chúng tôi sẽ hỗ trợ
									khách hàng tận tình và chu đáo . Chúc Quý khách hàng đặt vé
									thành công và có những trải nghiệm thú vị với HPV.</b>
							</p>
