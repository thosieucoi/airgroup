...
<title>Hồ sơ của bạn - Ahotua</title>
</head>
<body>
	<section id="break-crumb" class="row title-b">
		<article class="col-md-12 col-sm-12 col-xs-12">
			...
			<span class="">&gt;</span> <a
				href="${createLink(controller:'profile') }"
				class="current">Hồ sơ của bạn</a>
		</article>
	</section>
					...
					<div
						...
						<div
							...
							<div class="clearfix uiHeaderTop">
								<div>
									<h2 class="uiHeaderTitle" aria-hidden="true">Hồ sơ của bạn</h2>
								</div>
							</div>
						</div>
						<div class="phl ptm uiInterstitialContent">
							...
							<g:form controller="profile" action="save" method="POST"> 
									...
									<div class="pam login_error_box uiBoxBlue" role="alert"
										...
										<g:if test="${success}">
											<div class="fsl fwb fcb">
												Bạn đã cập nhật hồ sơ thành công!
											</div>
											<script>
													$('#successReg').show();
												</script>
									...
									<div id="loginform">
										<div class="form_row clearfix">
											<label for="email" class="login_form_label">Họ và tên <span>*</span></label>
										...
										<div class="form_row clearfix">
											<label for="email" class="login_form_label">Email <span>*</span></label>
										...
										<div class="form_row clearfix">
											<label for="pass" class="login_form_label"></label>
											<g:link controller="profile" action="changepassword"><span style="color:#428bca !important; text-decoration: underline;">Thay đổi mật khẩu</span></g:link>
										</div>
