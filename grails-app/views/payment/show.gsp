            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="payment.paymentName.label" default="Payment Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: paymentInstance, field: "paymentName")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="payment.status.label" default="Status" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: paymentInstance, field: "status")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="payment.orders.label" default="Orders" /></td>
