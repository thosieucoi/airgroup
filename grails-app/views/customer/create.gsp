                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: customerInstance, field: 'gender', 'errors')}">
                                    <g:select name="gender" from="${['0','1','2','3','4','5']}"
										valueMessagePrefix="common.gender"
										value="${customerInstance?.gender}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
								...
								<td valign="top"
									class="value ${hasErrors(bean: customerInstance, field: 'status', 'errors')}">
