...
function r(n,r,l){
	...
	function b(t){if(g()){
		...
		a>=te.start&&te.end>a?$.disableButton("prev"):$.enableButton("prev"),ue--,te.trigger("viewDisplay",se)
				}
	}
	function M(){
	...
	function C(){
		t.each(ce,function(t,e){e.sizeDirty=!0})
		}
	function S(){
	...
	function H(t){
		de=t,F()}function z(t){F(t)
			}
		function F(t){
			R(),g()&&(te.clearEvents(),te.renderEvents(de,t),te.eventsDirty=!1)
			}
		function R(){
			t.each(ce,function(t,e){e.eventsDirty=!0})
			}
		function N(t,n,r){
			te.select(t,n,r===e?!0:r)
			}
		function W(){
			te&&te.unselect()}function A(){b(-1)
				}
			function _(){
				b(1)
				}
			...
			function J(){
				return d(fe)}function V(){return te
					}
				function X(t,n){
...
function a(n,r){
	function a(){
		v=r.theme?"ui":"fc";var n=r.header;
			...
			t.each(this.split(","),
				...
				o=null;
					...
					if(n[i]?s=n[i]:De[i]&&(s=function(){
						u.removeClass(v+"-state-hover"),n.changeView(i)}),s)
					{
...
u=t("<span class='fc-button fc-button-"+i+" "+v+"-state-default'>"+(c?"<span class='fc-icon-wrap'><span class='ui-icon ui-icon-"+c+"'/>"+"</span>":l)+"</span>").click(function(){
	...
	.mousedown(function(){u.not("."+v+"-state-active").not("."+v+"-state-disabled").addClass(v+"-state-down")})
	.mouseup(function(){u.removeClass(v+"-state-down")}).hover(function(){u.not("."+v+"-state-active").not("."+v+"-state-disabled").addClass(v+"-state-hover")},
function(){u.removeClass(v+"-state-hover").removeClass(v+"-state-down")}).appendTo(a);
U(u),o||u.addClass(v+"-corner-left"),o=u}}}),
o&&o.addClass(v+"-corner-right")}),a}
	function s(t){h.find("h2").html(t)}function c(t){
	...
	h=t([])}
function o(n,r){
	function a(t,e){return!S||S>t||e>E
		}
	function o(t,e){
		S=t,E=e,W=[];var n=++F,r=z.length;R=r;for(var a=0;r>a;a++)i(z[a],n)
		}
	function i(e,r){
		s(e,function(a){
			if(r==F){
	...
	function s(r,a){var o,i,c=we.sourceFetchers;
		...
		month:"MMMM yyyy",week:"MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}",day:"dddd, MMM d, yyyy"
				...
				month:"ddd",week:"ddd M/d",day:"dddd M/d"
						...
						isRTL:!1,
						firstDay:0,
						monthNames:["Thg1","Thg2","Thg3","Thg4","Thg5","Thg6","Thg7","Thg8","Thg9","Thg10","Thg11","Thg12"],monthNamesShort:["Thg1","Thg2","Thg3","Thg4","Thg5","Thg6","Thg7","Thg8","Thg9","Thg10","Thg11","Thg12"],dayNames:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],
						dayNamesShort:["CN","T2","T3","T4","T5","T6","T7"],
						buttonText:{
							currency:"<span class='fc-text-arrow'>Đơn vị tiền tệ: VNĐ</span>",
							prev:"<span class='fc-text-arrow'>&lsaquo;</span>",
							next:"<span class='fc-text-arrow'>&rsaquo;</span>",
							prevYear:"<span class='fc-text-arrow'>&laquo;</span>",
							nextYear:"<span class='fc-text-arrow'>&raquo;</span>",
							today:"A",month:"month",week:"week",day:"day"},
							theme:!1,
							buttonIcons:{
								prev:"circle-triangle-w",
								next:"circle-triangle-e"},
								unselectAuto:!0,dropAccept:"*"},
								be={header:{left:"next,prev today",center:"currency",right:"title"},
					buttonText:{
						currency:"<span class='fc-text-arrow'>Đơn vị tiền tệ: VNĐ</span>",
